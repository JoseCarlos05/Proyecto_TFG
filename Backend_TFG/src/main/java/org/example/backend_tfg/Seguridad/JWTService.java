package org.example.backend_tfg.Seguridad;
...
import org.example.backend_tfg.DTOs.TokenDataDTO;
...
public class JWTService {
    ...
    public TokenDataDTO extractTokenData(String token){
        ...
        Map<String, Object> mapa = (Map<String, Object>) claims.get("tokenDataDTO");
